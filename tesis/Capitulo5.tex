...
\item [Datos de ingresos hospitalarios.] {Se agrupan en semanas epidemiológicas para una mejor manipulación de ellos. Por CIE se obtiene el numero de egresos en cada semana del año.}
...
\begin{itemize}
	...
	\item Número de series de tiempo a generar por contaminante. Se parte de la CIE con mayor numero de egresos.
\end{itemize}
...
En la figura \ref{serie_de_tiempo_2017_PM10} se muestra una de las series de tiempo generadas para la CIE con mayor numero de egresos registrados en el conjunto de datos del año. 
...
En la figura \ref{serie_de_tiempo_2018_PM10} se muestra una de las series de tiempo generadas para la CIE con mayor numero de egresos registrados en el conjunto de datos del año.
...
\subsubsection{Año 2017}
En la figura \ref{serie_de_tiempo_2017_PM25} se muestra una de las series de tiempo generadas para la CIE con mayor numero de egresos registrados en el conjunto de datos del año.
...
\subsubsection{Año 2018}
En la figura \ref{serie_de_tiempo_2018_PM25} se muestra una de las series de tiempo generadas para la CIE con mayor numero de egresos registrados en el conjunto de datos del año.
...
En el Experimento A el error RMSE en los modelos de regresión lineal varia entre 0.152 y 0.294, lo cual indica que no todos los resultados alcanzan una fiabilidad mayor al 80\%, excepto en la CIE K802 en el año 2018 en la cual se encuentra el porcentaje de error más bajo. 
...
En el Experimento B el error RMSE en los modelos de regresión lineal varia entre 0.159 y 0.278, lo cual indica que no todos los resultados alcanzan una fiabilidad mayor al 80\%, excepto en la CIE K802 en el año 2018 en la cual se encuentra el porcentaje de error más bajo.
...
\clearpage
Todos los experimentos son ejecutados en \texttt{Jupyter Notebook} \ref{tab:Herramientas utilizadas} en una laptop con las especificaciones del cuadro \ref{tab:Especificaciones técnicas del PC}.
