...
\begin{itemize}
	\item contaminante: El nombre del contaminante.
	\item año: El año del que se quieren obtener las series de tiempo.
	\item numcies: Número de series de tiempo a generar por contaminante. Se parte de la CIE \citep{r9} con mayor numero de egresos.
\end{itemize}
