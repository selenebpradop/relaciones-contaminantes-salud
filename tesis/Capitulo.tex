...
\begin{lstlisting}[language=Python, basicstyle=\tiny, caption=Procedimiento del segundo paso, label=lst:c1]
import pandas as pd
...
\begin{lstlisting}[language=Python, basicstyle=\tiny, caption=Procedimiento del segundo paso, label=lst:c2]
import pandas as pd
from epiweeks import Week, date
from sklearn import preprocessing
import seaborn as sns
...
\begin{lstlisting}[language=Python, caption=Procedimiento del segundo paso, basicstyle=\tiny, label=lst:c3]
...
\begin{lstlisting}[language=Python, caption=Procedimiento del segundo paso, basicstyle=\tiny, label=lst:c4]
